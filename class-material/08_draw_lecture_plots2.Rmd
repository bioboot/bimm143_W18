---
title: "BGGN-213: Visualization with R Lecture #8"
...
This document contains all the code used to generate the images for lecture number 8 of BGGN-213 ([Foundations of Bioinformatics](https://bioboot.github.io/bggn213_f17/)).  

This document is not meant to stand alone -- it has very little explanatory text.  It is meant to be a reference for students who want to see how the plots for the presentation were made. 
...
```{r}
theme_base_size <- 11
theme_preso <- theme_dark(base_size=theme_base_size)
 ...
 # 
 #         strip.text.x = element_text(size=rel(0.8), color="black",
