...
First, create a new RStudio project (File > New Project > New Directory > New Project) and download the input [airway_scaledcounts.csv](https://bioboot.github.io/bggn213_f17/class-material/airway_scaledcounts.csv) and [airway_metadata.csv](https://bioboot.github.io/bggn213_f17/class-material/airway_metadata.csv) into a new `data` sub-directory of your project directory.
...
We can add annotation from a supplied CSV file, such as those available from ENSEMBLE or UCSC. The [annotables_grch38.csv](https://bioboot.github.io/bggn213_f17/class-material/annotables_grch38.csv) annotation table links the unambiguous Ensembl gene ID to other useful annotation like the gene symbol, full gene name, location, Entrez gene ID, etc.
